...
class Interface(interface.Interface):
    ...
    def __init__(self, params=None):
        ...
        self.last_values = {
            ...
            'STE002:CONTROL_X': 0, #kV
            'STE002:CONTROL_Y': 0, #kV
            'EDE001:CONTROL': 0, #kV
            'EDE002:CONTROL': 0, #kV
            'QDE101:CONTROL_X': 0, #kV
            'QDE101:CONTROL_Y': 0, #kV
            'STE101:CONTROL_X': 0, #kV
            'STE101:CONTROL_Y': 0, #kV
        }
...
#        print(f"1-setting values main thread")
    ...
    def _update_json_config(self):
        ...
        try:
            ...
            config["good_tune"]["EBIS-E0E1"] = self.best_post_dict
