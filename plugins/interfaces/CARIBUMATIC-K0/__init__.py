...
class Interface(interface.Interface):
    ...
    def __init__(self, params=None): 
        ...
        self.last_values = {"QDK001:CONTROL_X": 0.0,
                            "QDK001:CONTROL_Y": 0.0,
                            "QHK001:CONTROL": 0.0,
                            "QSK001:CONTROL_Y": 0.0,
                            "STK000:CONTROL_X": 0.0,
                            "STK000:CONTROL_Y": 0.0,
                            "STK001:CONTROL_X": 0.0,
                            "STK001:CONTROL_Y": 0.0}  # Initialize with default or zeroes
    ...
    def beam_off(self):
        while not self.stop_thread:
            ...
            time.sleep(600)  # Sleep for five minutes. This gives time to the optimizer to increase the beam rate.    
    ...
    def _update_json_config(self):
        ...
        try:
            ...
            config['good_tune']['K0'] = self.best_post_dict
