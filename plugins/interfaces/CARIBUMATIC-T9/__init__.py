...
class Interface(interface.Interface):
    ...
    def __init__(self, params=None): 
        ...
        self.last_values = {'QTT905_X1:CONTROL': 0.0,
                            'QTT905_X2:CONTROL': 0.0,
                            'QTT905_Y:CONTROL': 0.0,
                            'STT905_X:CONTROL': 0.0,
                            'STT905_Y:CONTROL': 0.0,
                            'STT906_X:CONTROL': 0.0,
                            'STT906_Y:CONTROL': 0.0}  # Initialize with default or zeroes
