...
class Interface(interface.Interface):
    ...
    def __init__(self, params=None): 
        ...
        self.last_values = {"EDK201:CONTROL": 0,
                            "EZL005:CONTROL": 0,
                            "STK201:CONTROL_X": 0,
                            "STK201:CONTROL_Y": 0,
                            "STL005:CONTROL_X": 0,
                            "STL005:CONTROL_Y": 0}  # Initialize with default or zeroes
    ...
    def _update_json_config(self):
        ...
        try:
            ...
            # Update the "good_tune" -> "L0K2" entry with the best post_dict
            config['good_tune']['L0K2'] = self.best_post_dict
