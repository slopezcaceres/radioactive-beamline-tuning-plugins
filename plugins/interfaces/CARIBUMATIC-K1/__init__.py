...
class Interface(interface.Interface):
    ...
    def __init__(self, params=None): 
        ...
        self.last_values = {'QHK101:CONTROL': 0,
                            'QSK101:CONTROL_Y': 0,
                            'QTK101:CONTROL_X': 0,
                            'QTK101:CONTROL_X2': 0,
                            'QTK101:CONTROL_Y': 0,
                            ...
                            'STK101:CONTROL_Y': 0,
                            'STK102:CONTROL_X': 0,
                            'STK102:CONTROL_Y': 0}  # Initialize with default or zeroes
    ...
    def beam_off(self):
        while not self.stop_thread:
            ...
            lower_limit, upper_limit = self.environment.limit['STK000:CONTROL_X']
    ...
    def _update_json_config(self):
        ...
        try:
            ...
            # Update the "good_tune" -> "K1" entry with the best post_dict
            config['good_tune']['K1'] = self.best_post_dict
