...
class Interface(interface.Interface):
    ...
    def __init__(self, params=None): 
        ...
        self.last_values = {        'QTL001:CONTROL_X1': 0.0,
                                    'QTL001:CONTROL_X2': 0.0,
                                    'QTL001:CONTROL_Y': 0.0,
                                    'STL001:CONTROL_X': 0.0,
                                    'STL001:CONTROL_Y': 0.0,
                                    'STL002:CONTROL_X': 0.0,
                                    'STL002:CONTROL_Y': 0.0,}  # Initialize with default or zeroes
    ...
    def _update_json_config(self):
        ...
        try:
            ...
            config['good_tune']['L0'] = self.best_post_dict
