...
# K0 controls
key="LAUREL_RATEMETER"
awacsControls = [
                 {"device":"QDK001","chan":"CONTROL_X"},  
                 {"device":"QDK001","chan":"CONTROL_Y"},
                 {"device":"QHK001","chan":"CONTROL_X"},
                 {"device":"QSK001","chan":"CONTROL_Y"},
                 {"device":"STK000","chan":"CONTROL_X"},
                 {"device":"STK000","chan":"CONTROL_Y"},
                 {"device":"STK001","chan":"CONTROL_X"},
                 {"device":"STK001","chan":"CONTROL_Y"},
                 {"device":key,"chan":"READ"},]


#EBIS K4
#awacsControls = [
                 # {"device":"STK401","chan":"CONTROL_X"},  
                 # {"device":"STK401","chan":"CONTROL_Y"},
                 # {"device":"STK402","chan":"CONTROL_X"},
                 # {"device":"STK402","chan":"CONTROL_Y"},
                 # {"device":"QDK401","chan":"CONTROL_X"},
                 # {"device":"QDK401","chan":"CONTROL_Y"},
                 # {"device":"QDK402","chan":"CONTROL_X"},
                 # {"device":"QDK402","chan":"CONTROL_Y"},
                 #{"device":"EBIS_RATEMETER","chan":"READ"},]


awacsControlsReply = get(BASE_URL, json=awacsControls)
print("Status code:", awacsControlsReply.status_code)
print("Raw response:", awacsControlsReply.text)
print(awacsControlsReply)

awacsControlsJSON = awacsControlsReply.json()["data"][8]["val"]
