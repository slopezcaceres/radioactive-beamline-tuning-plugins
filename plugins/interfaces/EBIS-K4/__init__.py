...
class Interface(interface.Interface):
    ...
    def __init__(self, params=None):
        ...
        self.last_values = {
            'STK401:CONTROL_X': 0, #V
            'STK401:CONTROL_Y': 0, #V
            'STK402:CONTROL_X': 0, #kV
            'STK402:CONTROL_Y': 0, #kV
            'QDK401:CONTROL_X': 0, #V
            'QDK401:CONTROL_Y': 0, #V
            'QDK402:CONTROL_X': 0, #kV
            'QDK402:CONTROL_Y': 0, #kV
        }
    ...
    def _update_json_config(self):
        ...
        try:
            ...
            config["good_tune"]["EBIS-K4"] = self.best_post_dict
