...
Interface, configs_caribumatic = get_intf('EBIS-K4E0')
...
# Assuming you want the values under "good_tune" -> "EBIS-K4E0"
raw_init_values = config["good_tune"]["EBIS-K4E0"]
...
class Environment(environment.Environment):
    ...
    variables = {
        ...
        'STK402:CONTROL_X': [-1.0, 1.0], #kV
        'STK402:CONTROL_Y': [-1.0, 1.0], #kV
        'QDE001:CONTROL_X': [0.95, 1.35], #kV
        'QDE001:CONTROL_Y': [0.95, 1.35], #kV
        'QDE002:CONTROL_X': [0.95, 1.35], #kV
        'QDE002:CONTROL_Y': [1.35, 1.75], #kV
 }
