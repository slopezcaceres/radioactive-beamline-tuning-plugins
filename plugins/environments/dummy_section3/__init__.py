...
class Environment(environment.Environment):
    ...
    peak_x:Optional[float]=Field(default=250.0, description='maximum value of x')
    peak_y:Optional[float]=Field(default=450.0, description='maximum value of y')
    peak_rate:Optional[float]=Field(default=260.0, description='maximum value of rate')
