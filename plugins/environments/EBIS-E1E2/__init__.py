...
Interface, configs_caribumatic = get_intf('EBIS-E1E2')
...
# Assuming you want the values under "good_tune" -> "EBIS-E1E2"
raw_init_values = config["good_tune"]["EBIS-E1E2"]
...
class Environment(environment.Environment):
    ...
    variables = {
        ...
        'EDE001:CONTROL': [3.45, 3.65], #kV
        'EZE203:CONTROL': [3.5, 5.5], #kV
        'STE207:CONTROL_X': [-1.0, 1.0], #kV
        'STE207:CONTROL_Y': [-1.0, 1.0], #kV
    }
