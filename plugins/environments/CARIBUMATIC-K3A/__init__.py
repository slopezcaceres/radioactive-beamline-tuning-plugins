...
Interface, configs_caribumatic = get_intf('CARIBUMATIC-K3A')
...
# Assuming you want the values under "good_tune" -> "K3A"
raw_init_values = config["good_tune"]["K3A"]
...
class Environment(environment.Environment):
    ...
    variables = {
        'QDK301:CONTROL_X': [500, 2000],
        'QDK301:CONTROL_Y': [500, 2000],
        'QDK302:CONTROL_X': [500, 2000],
        'QDK302:CONTROL_Y': [500, 2000],
        'STK302:CONTROL_X': [-1000, 1000],
        'STK302:CONTROL_Y': [-1000, 1000],
    }
