...
Interface, configs_caribumatic = get_intf('CARIBUMATIC-K2K3')
...
# Assuming you want the values under "good_tune" -> "K2K3"
raw_init_values = config["good_tune"]["K2K3"]
...
class Environment(environment.Environment):
    ...
    variables = {
        'EDK202:CONTROL': [550, 750],
        'EDK203:CONTROL': [550, 750],
        'EDK204:CONTROL': [550, 750],
        'STK202:CONTROL_X': [-1000, 1000],
        'STK202:CONTROL_Y': [-1000, 1000],
        'STK301:CONTROL_X': [-1000, 1000],
        'STK301:CONTROL_Y': [-1000, 1000]
    }
